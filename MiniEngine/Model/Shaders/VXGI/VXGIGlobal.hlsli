...
#include "VXGIColorSpaceUtility.hlsli"
#include "VXGIPixelPacking_R11G11B10.hlsli"
#include "VXGIPixelPacking_RGBE.hlsli"
#include "VXGISH_Lite.hlsli"
...
float pixel_cone_spread_angle_from_image_height(float image_height, float4x4 inverse_projection)
{
    ...
    return atan(2.0 * inverse_projection._11 / image_height);
}
// https://media.contentapi.ea.com/content/dam/ea/seed/presentations/2019-ray-tracing-gems-chapter-20-akenine-moller-et-al.pdf
struct RayCone
{
...
RayCone pixel_ray_cone_from_image_height(float image_height, float4x4 inverse_projection)
{
    RayCone res;
    res.width = 0.0;
    res.spread_angle = pixel_cone_spread_angle_from_image_height(image_height, inverse_projection);
    return res;
}
